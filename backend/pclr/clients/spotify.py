...
from pclr.aws.dynamo import Dynamo
from pclr.aws.secretmanager import SecretManager
from pclr.models.track import Track
from pclr.telemetry.logging import logger
...
class SpotifyClient:
    ...
    def insert_track(self, track: Track) -> None:
        ...
        self.dynamo_client.insert_item(
            ...
            item={
                ...
                "track_name": track.name,
                "play_count": 1,
                "last_played_date": str(datetime.now()),
                "last_played_timestamp": int(datetime.now().timestamp()),
            },
        )
    ...
    def update_database(self, track: Track) -> None:
        ...
        self.update_track(
            track=track,
            update_expr="""
SET play_count = play_count + :c, last_played_date = :d, last_played_timestamp = :t
""",
            expr_vals={
                ":c": 1,
                ":d": str(datetime.now()),
